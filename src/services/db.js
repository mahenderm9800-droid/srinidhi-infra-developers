...
const initMockDB = () => {
  ...
  try {
    ...
    if (!storedSettings || storedSettings.includes('98765 43210') || storedSettings.includes('25+') || storedSettings.includes('650+') || storedSettings.includes('srinidhiinfra.com')) {
